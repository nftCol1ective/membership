...
export class MembershipCreated extends ethereum.Event {
  get params(): MembershipCreated__Params {
    return new MembershipCreated__Params(this);
  }
}

export class MembershipCreated__Params {
  _event: MembershipCreated;

  constructor(event: MembershipCreated) {
    this._event = event;
  }
...
export class Membership extends ethereum.SmartContract {
  ...
  mintNFT(
    ...
    let result = super.call(
      "mintNFT",
      "mintNFT(address,string,string,string,string):(uint256)",
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromString(name),
        ethereum.Value.fromString(profileId),
        ethereum.Value.fromString(tags),
